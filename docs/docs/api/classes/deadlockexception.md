...
\+ **new DeadlockException**(`previous`: [Error](driverexception.md#error)): [DeadlockException](deadlockexception.md)
...
**Returns:** [DeadlockException](deadlockexception.md)
