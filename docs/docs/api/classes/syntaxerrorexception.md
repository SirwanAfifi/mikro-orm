...
\+ **new SyntaxErrorException**(`previous`: [Error](driverexception.md#error)): [SyntaxErrorException](syntaxerrorexception.md)
...
**Returns:** [SyntaxErrorException](syntaxerrorexception.md)
