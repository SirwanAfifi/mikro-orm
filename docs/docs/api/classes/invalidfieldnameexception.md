...
\+ **new InvalidFieldNameException**(`previous`: [Error](driverexception.md#error)): [InvalidFieldNameException](invalidfieldnameexception.md)
...
**Returns:** [InvalidFieldNameException](invalidfieldnameexception.md)
