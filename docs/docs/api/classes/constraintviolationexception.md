...
* [ServerException](serverexception.md)
  ...
  ↳↳ [ForeignKeyConstraintViolationException](foreignkeyconstraintviolationexception.md)

  ↳↳ [NotNullConstraintViolationException](notnullconstraintviolationexception.md)

  ↳↳ [UniqueConstraintViolationException](uniqueconstraintviolationexception.md)

## Constructors

### constructor

\+ **new ConstraintViolationException**(`previous`: [Error](driverexception.md#error)): [ConstraintViolationException](constraintviolationexception.md)
...
**Returns:** [ConstraintViolationException](constraintviolationexception.md)
