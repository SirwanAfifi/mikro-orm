...
\+ **new TableNotFoundException**(`previous`: [Error](driverexception.md#error)): [TableNotFoundException](tablenotfoundexception.md)
...
**Returns:** [TableNotFoundException](tablenotfoundexception.md)
