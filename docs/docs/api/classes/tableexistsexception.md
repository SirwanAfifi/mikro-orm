...
\+ **new TableExistsException**(`previous`: [Error](driverexception.md#error)): [TableExistsException](tableexistsexception.md)
...
**Returns:** [TableExistsException](tableexistsexception.md)
