...
▸ `Static`**findOneFailed**(`name`: string, `where`: [Dictionary](../globals.md#dictionary) \| [IPrimaryKey](../globals.md#iprimarykey)): [NotFoundError](notfounderror.md)

*Defined in [packages/core/src/errors.ts:207](https://github.com/mikro-orm/mikro-orm/blob/d945b8a11/packages/core/src/errors.ts#L207)*
...
------ | ------ |
`name` | string |
`where` | [Dictionary](../globals.md#dictionary) \| [IPrimaryKey](../globals.md#iprimarykey) |
